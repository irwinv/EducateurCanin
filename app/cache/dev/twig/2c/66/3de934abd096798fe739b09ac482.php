...
\t\t<li><a href=\"";
        ...
        echo " \">Ajouter des Chiens/Chiots</a></li>
\t\t<li><a href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("elevage_concour_ajouter"), "html", null, true);
        echo " \">Ajouter un ou plusieurs Concours</a></li>
\t\t<li><a href=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("elevage_modifier_presentation", array("id" => 12)), "html", null, true);
        echo " \">Modifier texte de Présentation (page d'accueil)</a></li>
